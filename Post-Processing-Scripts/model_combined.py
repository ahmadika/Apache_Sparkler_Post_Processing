...
#This code is developed by Simin Ahmadi Karvigh and Omid Davtalab at USC IRDS Lab
...
def retSortedScore(keywordPath,solrLink,clfs,modelNames, rowsTokeep):
    ...
    for doc in docs:
        if 'extracted_text' in doc.keys():
            ...
            probList1=clfs[0].predict_proba([contentFeatures.toarray().sum(axis=0)])
